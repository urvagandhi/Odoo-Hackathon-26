...
import { X, BarChart3, TrendingUp, TrendingDown, Fuel, Receipt, IndianRupee } from "lucide-react";
...
/**
 * Slide-over panel that displays a trip's financial ledger (revenue, costs, profit, ROI) with detailed fuel logs and expenses.
 *
 * When `open` is true and `tripId` is provided, the component fetches ledger data, shows a loading spinner while fetching,
 * displays an error message on failure, and renders summary cards, cost breakdown, fuel logs, and expenses when data is available.
 *
 * @param open - Whether the drawer is visible
 * @param tripId - The trip identifier to load ledger data for; when null or undefined no fetch is performed
 * @param onClose - Callback invoked to close the drawer (also called when backdrop or close button is clicked)
 * @returns A slide-over React element that animates in/out and renders the trip ledger UI
 */
            ...
            <div className="flex-1 overflow-y-auto px-6 py-5 space-y-5">
              {loading && (
                <div className="py-12 text-center">
                  <svg className={`w-6 h-6 mx-auto animate-spin ${textSecondary}`} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
