...
/**
 * Slide-over form UI for creating a new trip with filtered vehicle/driver selectors, capacity validation, and submission.
 *
 * Renders a panel that loads available vehicles and on-duty drivers when opened, validates input (including vehicle capacity),
 * shows a dynamic capacity bar, and submits a trip payload to the dispatch API. Displays field and server errors and provides
 * localized labels and theming support.
 *
 * @param open - Whether the slide-over is visible
 * @param onClose - Callback invoked to close the slide-over
 * @param onSuccess - Callback invoked after a trip is successfully created
 * @returns The slide-over form React element for creating a trip
 */
