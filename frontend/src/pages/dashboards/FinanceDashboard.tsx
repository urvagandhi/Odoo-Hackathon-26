...
/**
 * Renders the finance dashboard UI showing YTD metrics, revenue vs. costs, monthly expenses, fleet fuel efficiency, and monthly fuel cost.
 *
 * Fetches monthly financial reports and fleet fuel-efficiency data on mount, shows a loading skeleton while data is loading, and adapts styling to the current theme.
 *
 * @returns A React element rendering the finance dashboard.
 */
