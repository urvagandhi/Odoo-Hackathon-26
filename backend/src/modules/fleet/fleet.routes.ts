...
// POST /api/v1/fleet/vehicles  (Manager / SuperAdmin only)
fleetRouter.post(
    '/vehicles',
...
// PATCH /api/v1/fleet/vehicles/:id  (Manager / SuperAdmin)
fleetRouter.patch(
    '/vehicles/:id',
    authorize([UserRole.SUPER_ADMIN, UserRole.MANAGER]),
...
// PATCH /api/v1/fleet/vehicles/:id/status  (Manager / Safety Officer)
fleetRouter.patch(
    '/vehicles/:id/status',
...
// DELETE /api/v1/fleet/vehicles/:id  (SuperAdmin only — soft delete)
fleetRouter.delete(
    '/vehicles/:id',
